...
passed in proof commit
[`42d8eeb`](https://github.com/jbruns/tv/commit/42d8eeb73e5e3a935f74575ab0c8e0c400375a78).
Every Python source file and test added by that commit is evidence-only. This
work does not integrate the existing shell implementation, define production
schemas, or begin the Reconciler implementation.
...
- [Selected ADR 0006](../adr/0006-python-foundation-toolchain.md)
- [Foundation research at accepted commit](https://github.com/jbruns/tv/blob/11ab5ee61de835d009847123299541790ac0255a/docs/research/2026-09-18-python-314-foundation.md)
