...
Complete both the shared guide's validation checklist and the [theater checklist](../README.md#room-validation) before eMMC migration. After a backup, follow the [shared service setup sequence](../../../docs/runbook.md#6-add-services-and-the-interface). Home Assistant power behavior and additional applications remain follow-on work.
